...
This is a continuation of the [Introduction to DSC (Part II)](Intro_Syntax_I.html). Here we continue the 
...
and script variable are conceptually distinct, even though they have the same name. By default DSC passes parameters to the script variable with the same name, but this behaviour can be modified by use of [@ALIAS](../reference/DSC_Configuration.html#Decorator-ALIAS-122).)
