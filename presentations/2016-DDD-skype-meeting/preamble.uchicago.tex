...
%\geometry{paperwidth = 3.5in, paperheight = 4.75in}
...
\setbeamercolor{itemize subitem}{fg=ucMaroon}

\setbeamercolor{section in toc}{fg=black}
\setbeamercolor{subsection in toc}{fg=ucDarkGray}
\setbeamercolor{section number projected}{bg=ucMaroon}
\setbeamercolor{subsection number projected}{bg=ucMaroon}
